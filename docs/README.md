...
| [Model-aware pilot plan](../tests/eval/PILOT.md) | Maintainer checks headroom, model-specific guidance hypotheses and execution prerequisites | Revisit after an observed failure, model/CLI change or completed pilot; offline matrix in pilot.json |
| [2026-09-25 branch review](../review.md) | Branch maintainer resolves evaluation findings before claiming a skill benefit | Revisit after runner fixes, the first attempt, or a target model/surface change |
